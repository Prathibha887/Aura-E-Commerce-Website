        ...
        <div class="forms">
            <div class="form login">
                ...
                <form action="#" enctype="multipart/form-data" method="post">
                    ...
                    <div class="input-field">
                    <input type="text" id="password" name="password" class="password" placeholder="Enter your password" required>
                    ...
                    <div class="input-field button">
                        <input type="submit" value="Login Now" id="btn"  name="login" required>
                        </div>
                </form>
                <div class="login-signup">
                    <span class="text">Not a member?
                        <a href="registration.php" class="text signup-text">Signup Now</a>
                    </span>
                </div>

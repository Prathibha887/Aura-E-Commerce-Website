...
<body>
    ...
    <section class="menu">
        ...
        <div class="items">
            ...
            <li><i class="fas fa-th-large"></i><a href="#">Popular</a></li>
...
if(isset($_POST['add_submit']))
{
    ...
    $oldprice = addslashes(trim($_POST['oldprice']));
    $newprice = addslashes(trim($_POST['newprice']));
		$fname = $_FILES["image"]["name"];
		$filename = $name.$fname;
		$tempname = $_FILES["image"]["tmp_name"];   
        $folder = "popular/".$filename;
		
        if (move_uploaded_file($tempname, $folder))  
		{
			$query ="INSERT INTO popular(image,categoryname,productname,oldprice,newprice) VALUES('".$filename."',' ".$categoryname." ',' ".$productname." ',' ".$oldprice." ',' ".$newprice." ')";
            mysqli_query($con, $query);
			echo "<script>
					alert(' uploaded Successfully');
				</script>";
			echo "<script> location.href='popular.php'; </script>";
        }else{
            echo "<script>
...
if (isset($_POST['update'])) {
    ...
    if ($image['error'] == 0) {
        ...
        if (move_uploaded_file($tempname, $folder)) {
            ...
            $query = "UPDATE popular SET image = '$filename', categoryname = '$categoryname', productname = '$productname', oldprice = '$oldprice' ,newprice = '$newprice' WHERE id = '$id'";

            if (mysqli_query($con, $query)) {
                echo "<script>alert('Popular updated successfully!');</script>";
                echo "<script>location.href='popular.php';</script>";
            } else {
                echo "<script>alert('Error updating Popular in database!');</script>";
            }
        } else {
...
if (isset($_POST['delete_submit'])) {
    ...
    if (mysqli_query($con, "DELETE from popular WHERE id = '$_POST[delete_id]'")) {

        echo "<script>alert('Popular deleted successfully');location.href='popular.php'</script>";
    } else {

        echo "<script>alert('Unable to process your request!');location.href='popular.php'</script>";
    }
}
?>
        ...
        <div class="values">
            <div class="val-box">
                <h4 class="admin_title">Add Popular</h4>
        ...
        <form method="post" action="#" enctype="multipart/form-data">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Add Popular</h5>
                ...
                <div class="modal-body">
                    <div class="modal-row">
                        ...
                        <div class="form-group">
                            <label for="old" class="col-form-label">Old Price:</label>
                            <input type="text" class="form-control" id="old" name="oldprice">
                        </div>
                        <div class="form-group">
                            <label for="new" class="col-form-label">New Price:</label>
                            <input type="text" class="form-control" id="new" name="newprice">
                        </div>
                    </div>
                </div>
...
?>
                    <tr>
                        ...
                        <td><img  src="popular/<?php echo $image; ?>" width="70" height="70" alt=""></td>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="addLabel">Update Popular</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
    ...
    <div class="modal-body">
        ...
        <p>Current Image: <?php echo $image; ?></p>
                        ...
                        <div class="form-group">
                            <label for="old" class="col-form-label">Old Price:</label>
                            <input type="text" class="form-control" id="old" name="oldprice" value="<?php echo $oldprice; ?>" required>
                        </div>
                        <div class="form-group">
                            <label for="new" class="col-form-label">New Price:</label>
                            <input type="text" class="form-control" id="new" name="newprice" value="<?php echo $newprice; ?>" required>
                        </div>
